...
const Blog = () => {
  ...
  const addComment = async (e) => {
    e.preventDefault();
    try {
      const { data } = await axios.post('/api/blog/add-comment', {blogId: id, name,
         content});
         if(data.success){
  ...
  return data ?(
    <div className='relative'>
      ...
      <div className='text-center mt-20 text-gray-600'>
       ...
       border-primary/35 bg-primary/5 font-medium text-primary'>Santhosh Teja</p>
      </div>

    <div className='mx-5 max-w-5xl md:mx-auto my-10 mt-6'>
      <img src={data.image} alt="" className='rounded3xl mb-5'/>
